...
class AlbumDetailPageUser extends StatefulWidget {
  Album album; // Hapus final

  AlbumDetailPageUser({Key? key, required this.album}) : super(key: key);

  @override
  State<AlbumDetailPageUser> createState() => _AlbumDetailPageStateUser();
}

class _AlbumDetailPageStateUser extends State<AlbumDetailPageUser>
